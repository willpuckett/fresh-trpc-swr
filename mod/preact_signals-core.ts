...
r.prototype.peek = function() {
    if (this.h() || v(), 16 & this.f) throw this.v;
    return this.v;
};
...
function g(i) {
    ...
    w(this), s = i, this.f &= -2, 8 & this.f && l(this), d();
}
function c(i) {
...
c.prototype.S = function() {
    1 & this.f && v(), this.f |= 1, this.f &= -9, x(this), S(this), h++;
    let i = s;
    return s = this, g.bind(this, i);
};
...
export { n as Signal, N as batch, k as computed, U as effect, O as signal };
